const projectsData = [
  {
    ...
    imgSrc: '/static/images/projects/phonestore.PNG',
    href: 'https://react-phoneapp.netlify.app/',
  },
  {
    ...
    imgSrc: '/static/images/projects/djangoEcommerce.PNG',
  ...
  },
  {
    ...
    href: 'https://github.com/meekkaran/attachment-system',
  },
  {
    title: 'Music Playing System',
    description: `AA collaborative music playing system that lets people have control over the music being played. The users of the system are: HOST who is in charge of creating and controlling music and the users who access the music system, vote for a specific song, play ad pause a song depending on the host's persmission.`,
    imgSrc: '/static/images/projects/music.png',
    href: 'https://musicparty.meekkaran.com/',
  },
  {
    ...
    imgSrc: '/static/images/projects/library.PNG',
    href: 'https://library.meekkaran.com/',
  },
